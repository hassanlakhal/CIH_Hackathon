  ...
  return (
    <div className={`flex flex-col items-center justify-center py-16 gap-4 ${className}`}>
      ...
      <div className="flex items-center gap-1.5">
        <span className="w-2.5 h-2.5 rounded-full bg-aura-400 animate-pulse-soft" style={{ animationDelay: '0ms' }} />
        <span className="w-2.5 h-2.5 rounded-full bg-aura-300 animate-pulse-soft" style={{ animationDelay: '200ms' }} />
        <span className="w-2.5 h-2.5 rounded-full bg-aura-200 animate-pulse-soft" style={{ animationDelay: '400ms' }} />
      </div>
